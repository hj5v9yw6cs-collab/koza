      ...
      <section style={{ paddingTop: 0 }}>
        <div className="wrap hero-grid">
          <div className="hero-meta">
            ...
            <p className="lead">
              Материалы — профессиональные бренды, инструмент проходит полный цикл
              стерилизации, пилки и файлы одноразовые. Если у тебя чувствительная кожа
              или тонкие ногти — скажи заранее, буду аккуратнее.
            </p>
          </div>
